    ...
    <Section>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-semibold mb-4">Cutting-Edge Features</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Resume Feedback */}
          <div className="bg-card p-6 rounded-lg shadow-md transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg">
            ...
            <h3 className="text-2xl font-semibold mb-3">AI-Powered Resume Analysis</h3>
          ...
          <div className="bg-card p-6 rounded-lg shadow-md transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg">
            ...
            <h3 className="text-2xl font-semibold mb-3">Smart Job Validation</h3>
            <p className="text-muted-foreground mb-4">
