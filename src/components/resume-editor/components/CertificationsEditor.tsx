...
interface CertificationsEditorProps {
  ...
  onAdd: (certification: CertificationItem) => void;
  onUpdate: (id: string, data: Omit<CertificationItem, 'id'>) => void;
...
export function CertificationsEditor({
  ...
  description = "Add professional certifications, licenses, and courses you've completed."
